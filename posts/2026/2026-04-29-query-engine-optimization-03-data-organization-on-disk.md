...
![The write speed vs read efficiency spectrum showing heap files, LSM trees, B-trees, and sorted files](/images/2026/query-engine-optimization/03-data-organization-on-disk/write-read-spectrum.png)
...
![Anatomy of a Parquet file showing row groups, column chunks, pages, and the footer with schema and statistics](/images/2026/query-engine-optimization/03-data-organization-on-disk/parquet-file-anatomy.png)
...
![How min/max statistics allow the engine to skip irrelevant row groups when filtering by price](/images/2026/query-engine-optimization/03-data-organization-on-disk/predicate-pushdown-min-max.png)
