...
![How table formats solved the chaos of raw data lakes with a structured metadata layer](/images/2026/apache-iceberg-masterclass/01-table-formats/before-after-table-formats.png)
...
![Timeline showing the evolution from Hive Metastore through Hudi, Iceberg, Delta Lake, Paimon, and DuckLake](/images/2026/apache-iceberg-masterclass/01-table-formats/format-evolution-timeline.png)
...
![Positioning chart showing where Iceberg, Delta Lake, Hudi, Paimon, and DuckLake sit on batch vs streaming and single vs multi-engine axes](/images/2026/apache-iceberg-masterclass/01-table-formats/format-positioning-chart.png)
...
The rest of this series focuses on Iceberg because its design decisions and capabilities represent the state of the art for multi-engine analytical lakehouses. [Part 2](/posts/2026/2026-04-29-apache-iceberg-masterclass-02-metadata-structures) examines the metadata structures of all five formats in detail.
