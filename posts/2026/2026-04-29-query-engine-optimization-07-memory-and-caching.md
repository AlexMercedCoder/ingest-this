...
date: "2026-04-29"
description: "<!-- Meta Description: Databases use buffer pools, column caches, and result caches to keep hot data in RAM. Here is how each caching strategy works and what happens when data does not fit. -->"
author: "Alex Merced"
...
![Cache hit versus cache miss latency showing the 1000x gap between RAM and SSD access](/images/2026/query-engine-optimization/07-memory-and-caching/cache-hit-miss-latency.png)
...
![Buffer pool architecture showing shared memory pages, page table, cache hits, and background writes to disk](/images/2026/query-engine-optimization/07-memory-and-caching/buffer-pool-architecture.png)
...
![How engines divide available memory between data cache, sort buffers, hash tables, and network buffers](/images/2026/query-engine-optimization/07-memory-and-caching/memory-budget-allocation.png)
