...
bannerImage: "/images/apache-lakehouse/serialization-tax.png"
tags:
  - data lakehouse
  - apache iceberg
  - open source
...
![Diagram showing the serialization tax burning CPU cycles while translating data between languages](/images/apache-lakehouse/serialization-tax.png)
...
![Zero-Copy architecture showing two different languages pointing to the exact same memory buffer](/images/apache-lakehouse/zero-copy-arrow.png)
...
![Arrow Flight RPC versus traditional REST/ODBC protocols over a network](/images/apache-lakehouse/arrow-flight-rpc.png)
