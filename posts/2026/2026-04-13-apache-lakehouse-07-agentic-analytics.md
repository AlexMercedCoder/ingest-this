...
bannerImage: "/images/apache-lakehouse/ai-sql-functions.png"
tags:
  - data lakehouse
  - apache iceberg
  - open source
...
![The Semantic layer translating raw Iceberg datasets into AI-ready business context](/images/apache-lakehouse/semantic-layer-translation.png)
...
![Autonomous Reflections lifecycle showing query monitoring, background creation, and query acceleration](/images/apache-lakehouse/autonomous-reflections.png)
...
![AI SQL Function executing inside a Dremio query against Parquet data](/images/apache-lakehouse/ai-sql-functions.png)
