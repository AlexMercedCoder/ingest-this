...
![How Python libraries and MPP engines connect to Iceberg tables](/images/2026/apache-iceberg-masterclass/12-python-and-mpp/python-iceberg-stack.png)
...
![The five-step PyIceberg workflow from catalog connection to analysis](/images/2026/apache-iceberg-masterclass/12-python-and-mpp/pyiceberg-workflow.png)

PyIceberg leverages Iceberg's [metadata-driven pruning](/posts/2026/2026-04-29-apache-iceberg-masterclass-03-iceberg-metadata-performance): the `row_filter` is pushed down to manifest evaluation, so only relevant data files are read. For reading subsets of large tables into Python for analysis or ML training, this is remarkably efficient.
...
DuckDB also supports reading Iceberg metadata tables, which means you can use it for [table health diagnostics](/posts/2026/2026-04-29-apache-iceberg-masterclass-09-storage-degradation) without standing up a full query engine.
...
This creates a new Iceberg [commit](/posts/2026/2026-04-29-apache-iceberg-masterclass-06-writing-to-iceberg) with the data files, manifests, and metadata. PyIceberg handles the entire write lifecycle, including partition assignment based on the table's [partition spec](/posts/2026/2026-04-29-apache-iceberg-masterclass-05-hidden-partitioning).
...
![Comparison of MPP engines for Iceberg workloads showing read, write, and maintenance capabilities](/images/2026/apache-iceberg-masterclass/12-python-and-mpp/mpp-engine-comparison.png)
...
Apache Spark is the most mature Iceberg engine for both reads and writes. It handles batch ETL, streaming ingestion ([Part 13](/posts/2026/2026-04-29-apache-iceberg-masterclass-13-streaming-to-iceberg)), and all [maintenance operations](/posts/2026/2026-04-29-apache-iceberg-masterclass-10-maintaining-iceberg). Most Iceberg production pipelines use Spark for data ingestion because of its extensive connector ecosystem (Kafka, JDBC, file formats) and its ability to process large volumes across a distributed cluster.
...
[Part 13](/posts/2026/2026-04-29-apache-iceberg-masterclass-13-streaming-to-iceberg) covers how to stream data into Iceberg tables.
