...
![Architecture diagram showing multiple engines like Spark, Flink, Trino, and Snowflake communicating with a unified Iceberg REST Catalog control plane which delegates to S3 storage](/images/2026/choosing-iceberg-control-plane/control-plane-architecture.png)
...
![Stack diagram showing the security and catalog commit layers of modern Iceberg control planes including RBAC, credential vending, and multi-engine commits](/images/2026/choosing-iceberg-control-plane/catalog-governance-comparison.png)
...
![Flowchart decision tree helping engineers evaluate catalog requirements and select the correct Iceberg control plane](/images/2026/choosing-iceberg-control-plane/catalog-selection-flowchart.png)
