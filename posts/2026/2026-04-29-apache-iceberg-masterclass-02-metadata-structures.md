...
![Iceberg's three-layer metadata architecture from catalog to metadata.json to manifest list to manifest files to data files](/images/2026/apache-iceberg-masterclass/02-metadata-structures/iceberg-metadata-tree.png)
...
![Delta Lake's transaction log structure with JSON commits, Parquet checkpoints, and the reader process](/images/2026/apache-iceberg-masterclass/02-metadata-structures/delta-lake-transaction-log.png)
...
![Five approaches to table metadata from file-based to database-backed](/images/2026/apache-iceberg-masterclass/02-metadata-structures/metadata-architecture-comparison.png)
...
[Part 3](/posts/2026/2026-04-29-apache-iceberg-masterclass-03-iceberg-metadata-performance) covers how query engines use Iceberg's metadata specifically for performance optimization.
