...
![The three core responsibilities of a lakehouse catalog](/images/2026/apache-iceberg-masterclass/07-lakehouse-catalogs/catalog-role.png)

Every Iceberg catalog performs three functions:

**Store the current metadata pointer.** When a query engine asks for table `analytics.orders`, the catalog returns the location of the current `metadata.json` file (e.g., `s3://warehouse/orders/metadata/v42.metadata.json`). This is the most fundamental responsibility. As described in [Part 6](/posts/2026/2026-04-29-apache-iceberg-masterclass-06-writing-to-iceberg), the atomic update of this pointer is what makes ACID transactions possible.
...
![How the Iceberg REST Catalog Protocol works from table load through atomic commit](/images/2026/apache-iceberg-masterclass/07-lakehouse-catalogs/rest-catalog-protocol.png)
...
![Open source vs managed catalog options in the 2026 lakehouse ecosystem](/images/2026/apache-iceberg-masterclass/07-lakehouse-catalogs/catalog-landscape.png)
...
[Part 8](/posts/2026/2026-04-29-apache-iceberg-masterclass-08-embedded-catalogs) covers a newer approach where the catalog is embedded directly in the storage layer.
