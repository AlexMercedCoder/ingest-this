...
bannerImage: "/images/2026/paimon-vs-iceberg-mutable-streams/paimon-lsm-vs-iceberg-mor-architecture.png"
tags:
...
![Architecture diagram comparing Paimon LSM-tree with in-memory buffer, SSTable file levels, and background compaction against Iceberg merge-on-read with separate data files and delete files requiring query-time merge](/images/2026/paimon-vs-iceberg-mutable-streams/paimon-lsm-vs-iceberg-mor-architecture.png)
...
![Two-by-two decision matrix showing Paimon as best choice for high-frequency CDC workloads with narrow Flink-focused ecosystem, and Iceberg as best for broad multi-engine access regardless of update frequency](/images/2026/paimon-vs-iceberg-mutable-streams/paimon-vs-iceberg-workload-decision-matrix.png)
...
One of Paimon's most distinctive features is its native support for streaming aggregations, which are running computations that accumulate over time directly in the table format.
