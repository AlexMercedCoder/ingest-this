...
![Hive-style directory-based partitioning with its three core problems](/images/2026/apache-iceberg-masterclass/04-partition-evolution/hive-partition-directories.png)
...
![Iceberg partition evolution showing how old and new partition specs coexist without rewriting data](/images/2026/apache-iceberg-masterclass/04-partition-evolution/iceberg-partition-evolution.png)

Iceberg separates the logical partition specification from the physical data layout through two mechanisms: hidden partitioning (covered in [Part 5](/posts/2026/2026-04-29-apache-iceberg-masterclass-05-hidden-partitioning)) and partition evolution.
...
![How engines resolve queries across multiple partition specs by evaluating each independently](/images/2026/apache-iceberg-masterclass/04-partition-evolution/multi-spec-query-planning.png)
...
Partition evolution is one of the features that makes Iceberg a safe long-term choice. It means the partitioning decision you make today is not permanent. [Part 5](/posts/2026/2026-04-29-apache-iceberg-masterclass-05-hidden-partitioning) covers hidden partitioning, the other half of Iceberg's partitioning story.
