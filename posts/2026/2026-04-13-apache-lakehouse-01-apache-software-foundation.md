...
bannerImage: "/images/apache-lakehouse/asf-vs-lf-comparison.png"
tags:
  - data lakehouse
  - apache iceberg
  - open source
...
![The Apache Incubation Process flow showing Podling, Mentorship, IP Clearance, and Graduation to TLP](/images/apache-lakehouse/asf-incubation-process.png)
...
![Comparison Diagram of ASF versus Linux Foundation showing individual vs corporate membership](/images/apache-lakehouse/asf-vs-lf-comparison.png)
...
![Three layers of the Apache Lakehouse stacked under the ASF Umbrella showing Parquet, Iceberg, and Arrow](/images/apache-lakehouse/apache-lakehouse-umbrella.png)
