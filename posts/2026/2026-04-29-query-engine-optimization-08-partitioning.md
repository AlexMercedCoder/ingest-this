...
![Hash, range, and list partitioning strategies showing how the same data is distributed differently](/images/2026/query-engine-optimization/08-partitioning/partition-types.png)
...
![Partition pruning showing 5 of 6 monthly partitions skipped when filtering by March](/images/2026/query-engine-optimization/08-partitioning/partition-pruning.png)
...
![The data skew problem showing one partition with 10x more data creating a straggler node](/images/2026/query-engine-optimization/08-partitioning/data-skew-problem.png)
