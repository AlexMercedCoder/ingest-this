...
date: "2026-04-29"
description: "<!-- Meta Description: Iceberg's three-layer metadata tree eliminates directory listing and enables multi-level data skipping. Here is how scan planning actually works. -->"
author: "Alex Merced"
...
![Iceberg scan planning cascade showing how metadata progressively eliminates files at each stage](/images/2026/apache-iceberg-masterclass/03-iceberg-metadata-performance/scan-planning-cascade.png)
...
![Three layers of data skipping showing partition pruning, file pruning, and the final result](/images/2026/apache-iceberg-masterclass/03-iceberg-metadata-performance/pruning-example.png)
...
![Per-file statistics tracked in Iceberg manifest entries](/images/2026/apache-iceberg-masterclass/03-iceberg-metadata-performance/per-file-statistics.png)
...
2. **Consider partition evolution** (covered in [Part 4](/posts/2026/2026-04-29-apache-iceberg-masterclass-04-partition-evolution)) to add a partition transform on the column.
