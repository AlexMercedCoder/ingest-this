...
bannerImage: "/images/apache-lakehouse/iceberg-time-travel.png"
tags:
  - data lakehouse
  - apache iceberg
  - open source
...
![The Iceberg Metadata Tree showing the path from Catalog down to Data Files](/images/apache-lakehouse/iceberg-metadata-tree.png)
...
![Diagram showing Schema Evolution mapping unique column IDs to file structures over time](/images/apache-lakehouse/iceberg-schema-evolution.png)
...
![Diagram showing Time Travel snapshots pointing an overlapping set of underlying Parquet files](/images/apache-lakehouse/iceberg-time-travel.png)
