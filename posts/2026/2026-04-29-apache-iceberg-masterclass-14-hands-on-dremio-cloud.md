...
date: "2026-04-29"
description: "<!-- Meta Description: A practical walkthrough of creating, querying, and optimizing Iceberg tables on Dremio Cloud, from account setup to AI-powered analytics. -->"
author: "Alex Merced"
...
![From zero to Iceberg in six steps on Dremio Cloud](/images/2026/apache-iceberg-masterclass/14-hands-on-dremio-cloud/dremio-iceberg-workflow.png)
...
This creates a table with [hidden partitioning](/posts/2026/2026-04-29-apache-iceberg-masterclass-05-hidden-partitioning) by day. Users query on `order_date` naturally; the engine handles partition pruning automatically.
...
![Dremio Cloud features for Iceberg including Open Catalog, federation, semantic layer, and AI](/images/2026/apache-iceberg-masterclass/14-hands-on-dremio-cloud/dremio-platform-features.png)
...
This eliminates the need to move all data into Iceberg before you can query it. You can [start with federation and migrate incrementally](https://www.dremio.com/blog/the-journey-from-scattered-data-to-an-apache-iceberg-lakehouse-with-governed-agentic-analytics/). Federation is especially useful during [migration](/posts/2026/2026-04-29-apache-iceberg-masterclass-15-migrating-to-iceberg): query legacy systems and Iceberg tables side by side, then swap the underlying source when you are ready.

## Essential SQL Operations

![Four essential Iceberg SQL operations on Dremio: CREATE, COPY INTO, OPTIMIZE, and time travel](/images/2026/apache-iceberg-masterclass/14-hands-on-dremio-cloud/dremio-sql-examples.png)
...
[Part 15](/posts/2026/2026-04-29-apache-iceberg-masterclass-15-migrating-to-iceberg) covers strategies for migrating existing data into Iceberg.
